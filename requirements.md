...
**Описание.** Пользователь может настроить внешний вид приложения под свой вкус.

**Требование.** Приложение должно предоставить выбор текстур фигур, цветов игровой доски, фона, кнопок и панелей.
